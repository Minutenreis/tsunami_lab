...
* execute the Program with :code:`./build/tsunami_lab [-s solver] [-u setup] [-b "boundary_left boundary_right"] [-r stationsJson] n_cells_x` 
...
| :code:`[-u setup]` = choose between :code:`'DamBreak1d h_l h_r'`, :code:`'ShockShock1d h hu'`,
 ...
 :code:`Supercrit1d`, :code:`'Tsunami1d path_to_csv time_simulated'`, :code:`'ArtificialTsunami2d time_simulated'`, :code:`DamBreak2d` , default is :code:`'DamBreak1d 10 5'`
